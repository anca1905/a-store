        ...
        <div class="table-responsive">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn-action-icon btn-edit"
                                    onclick="editKategori(<?= $row['id_kategori'] ?>, '<?= htmlspecialchars($row['nama_kategori'], ENT_QUOTES) ?>')"
                                    title="Edit">
                    ...
                    <?php endwhile; else: ?>
                    <tr><td colspan="3" style="text-align:center; padding:40px; color:var(--text-muted);">Belum ada kategori. Tambahkan kategori baru.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<div id="modalTambahKat" class="modal">
    <div class="modal-content" style="max-width:420px;">
        ...
        <form action="action_kategori.php" method="POST">
